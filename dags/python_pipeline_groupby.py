...
def groupby_smoker(ti):
    ...
    smoker_df.to_csv(
        '/Users/mujtabaalimalik/airflow/output/grouped_by_smoker.csv', index=False)
...
def groupby_region(ti):
    ...
    region_df.to_csv(
        '/Users/mujtabaalimalik/airflow/output/grouped_by_region.csv', index=False)


with DAG(
    dag_id = 'python_pipeline_groupby',
